...
function ve_get_post_setting($key,$post_id=0){
    if(!$post_id){
        $post_id=get_the_ID();
    }
...
function ve_update_post_setting($post_id,$setting_key,$setting_value){
    if(!$post_id){
        $post_id=get_the_ID();
    }
    $settings=get_post_meta($post_id,'ve_settings',true);
    ...
    update_post_meta($post_id,'ve_settings',$settings);
}
