...
(function(ve,$){
    ...
    ve.ElementFormView=Backbone.View.extend({//el=.ve-form-wrapper
        ...
        getElement:function(){
            return ve.getElementById(this.$form.data('element'));
        },
        setTitle:function(t){
    ...
    ve.PanelView=Backbone.View.extend({
        ...
        initialize:function(){
            ...
            this.$element_form=this.$elements.filter('.element-group-form');
            this.$elements=this.$elements.filter(function(){
                return !$(this).hasClass('element-group-form');
            });
        ...
        filterElements:function(filter){
            ...
            if (filter=='default')
            {
                ...
                this.$elementsList.filter('[data-group=default]').show();
                this.$elementsList.filter('[data-group=form]').show();
                return;
            }
            this.$elementsList.hide();
