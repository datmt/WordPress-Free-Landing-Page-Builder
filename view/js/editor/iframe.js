...
(function(iframe,$) {
    ...
    iframe.setSortable = function(){
        ...
        $('.ve_element-ve_form>.ve_element_wrapper>.ve_element_container').sortable({
            forcePlaceholderSize: true,
            helper: this.renderPlaceholder,
            distance: 3,
            scroll: true,
    ...
    window.ve_iframe_load=function (){
        if(parent.ve&&!parent.ve.loaded){
            try{
                parent.ve.load();
            }catch(e){
                setTimeout(function(){window.ve_iframe_load();},200);
            }
    ...
    window.ve_iframe_control_init=function(){
