...
class VeCore_VeText extends Ve_Element implements VE_Element_Interface{
    ...
    function init(){
	    ...
	    $this->ready('if (typeof ve_front !== "undefined"){ve_front.text.start();}');
    ...
    function form($instance,$content=''){
        ...
        <p><label for="<?php echo $this->get_field_id('class'); ?>"><?php _e('Extra class:'); ?></label>
            <input class="" id="<?php echo $this->get_field_id('class'); ?>" name="<?php echo $this->get_field_name('class'); ?>" type="text" value="<?php echo esc_attr($instance['class']); ?>" /></p>
